...
class SneakerListPresenterTest {
    ...
    fun defaultViewModel() {
        presenter.defaultViewModel() shouldEqual
                SneakerListViewModel(listOf(), false, null, "")
    }
    ...
    fun fetchSneakersSuccess() {
        //Arrange
        val items = listOf(
                SneakerListItemViewModel(id = 0L,
                        name = "",
                        categoryName = "", collectionName = "", price = 0.0, imageUrl = ""))
