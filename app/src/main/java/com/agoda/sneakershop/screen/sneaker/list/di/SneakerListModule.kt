...
class SneakerListModule {
    ...
    @Provides
    fun provideSneakerListItemViewModelMapper(): SneakerListItemViewModelMapper =
            SneakerListItemViewModelMapperImpl()
    ...
    @Provides
    fun provideSneakerListAdapter(): SneakerListAdapter =
            SneakerListAdapter()

    @Provides
    fun provideSneakerListPresenter(sneakerListInteractor: SneakerListInteractor): SneakerListContract.Presenter =
            SneakerListPresenter(sneakerListInteractor)
