...
class SneakerListInteractorImpl(private val sneakerRepository: SneakerRepository,
                                private val schedulerProvider: SchedulerProvider,
                                private val mapper: SneakerListItemViewModelMapper) : SneakerListInteractor {

    override fun getSneakers(query: String): Observable<List<SneakerListItemViewModel>>
            = sneakerRepository.getSneakers(query)
